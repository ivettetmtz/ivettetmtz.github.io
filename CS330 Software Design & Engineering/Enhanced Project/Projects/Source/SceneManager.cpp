...
void SceneManager::LoadSceneTextures()
{
	...
	this->CreateGLTexture("../../Utilities/textures/knife_handle.jpg", "wood");
	this->CreateGLTexture("../../Utilities/textures/grass.jpg", "grass");
	this->CreateGLTexture("../../Utilities/textures/Rubber.jpeg", "rubber");
	this->CreateGLTexture("../../Utilities/textures/Pattern.jpeg", "pattern");
	...
	//Added new textures for new added objects
	this->CreateGLTexture("../../Utilities/textures/rocktexture.jpg", "rock");
	this->CreateGLTexture("../../Utilities/textures/pavers.jpg", "pavers");
...
void SceneManager::SetupSceneLights()
{
	...
	//Light Source Two
	m_pShaderManager->setVec3Value("lightSources[1].position", glm::vec3(6.0f, 10.0f, -24.0f));
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", glm::vec3(-10.0f, 10.0f, 0.0f));

	// Light orange light (mix of red and green with little or no blue)
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", glm::vec3(0.6f, 0.2f, 0.0f));  
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", glm::vec3(0.5f, 0.0f, 0.0f)); 
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", glm::vec3(0.5f, 0.0f, 0.0f));

	m_pShaderManager->setFloatValue("lightSources[1].focalStrength", 32.0f);
	m_pShaderManager->setFloatValue("lightSources[1].specularIntensity", 0.4f);

	//Initiating the lighting
...
void SceneManager::RenderScene()
{
	...
	// TAPERED CYLINDER FOR RING TOSS STAND
	// set the XYZ scale for the mesh
	...
	// SPHERE FOR BELL INSIDE PLASTIC BALL TOY
	// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.3f, 0.6f, 0.7f);
	...
	// Gave the wheels of the skate a stainless center look
	...
	// TORUS FOR SECOND WHEEL OF CART 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 0.5f, 0.5f);
	...
	// DETAIL FOR THE SECOND WHEEL OF CART 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.2f, 0.3f);
	...
	// DETAIL FOR THE THIRD WHEEL OF CART 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.2f, 0.3f);
	...
	// TORUS FOR FOURTH WHEEL OF CART 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 0.5f, 0.5f);
	...
	// DETAIL FOR THE FOURTH WHEEL OF CART 
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.2f, 0.3f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.6f, 0.6f, 1.3f);
	...
	// STEEL BLOCK TO HOLD WHEELS FROM CART
	// set the XYZ scale for the mesh
	...
	// PLANE FOR BACKGROUND - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(15.0f, 0.5f, 10.0f);
	...
	// Used a pavement texture to reflect a brick wall
	...
	// PLANE FOR BACKGROUND SIDE ONE - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(15.0f, 0.5f, 10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(15.0f, 10.0f, 0.0f);
	...
	// PLANE FOR BACKGROUND SIDE TWO - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(15.0f, 0.5f, 10.0f);
	...
	// CYLINDER FOR BASKETBALL STAND - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.2f, 0.3f, 2.2f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(6.0f, 0.2f, -5.0f);
	...
	// CYLINDER FOR BASKETBALL STAND - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 4.0f, 0.5f);
	...
	// set the texture to reflect wood
	SetShaderTexture("rusticwood");
	SetShaderMaterial("wood");
	...
	// BOX SQUARE FOR BASKETBALL STAND - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.0f, 0.2f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(6.0f, 4.5f, -4.5f);
	...
	// set the texture to a rock color with a stainless material
	...
	// TORUS FOR THE HOOP ON BASKETBALL STAND - ENHANCEMENT
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(6.0f, 3.7f, -3.3f);
	...
	// set the hoop to be stainless in both texture and material
	SetShaderTexture("stainless");
	SetShaderMaterial("stainless");
